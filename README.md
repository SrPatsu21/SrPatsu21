...
Bem-vindo ao meu perfil! Aqui você vai encontrar informações sobre minhas habilidades, projetos e estatísticas de contribuição no GitHub.

---

## 🔭 O que estou fazendo atualmente
- Construindo projetos com **JavaScript, Python e React**
- Aprimorando conhecimentos em **DevOps e Cloud (AWS/GCP)**
- Explorando novas tecnologias como **AI e Machine Learning**
...
- Python para automação e Data Science
...
## ⚡ Curiosidade
- Sou fascinado por **inteligência artificial, física quântica e ciência de dados**
- Gosto de criar **scripts e bots que automatizam tarefas do dia a dia**
- Sempre busco aprender **novas tecnologias e boas práticas de desenvolvimento**
